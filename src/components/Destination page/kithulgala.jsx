...
export default function DestinationPlace() {
  const mustVisitPlaces = [
    {
      src: "/Must visting/Canyoning & Waterfall Abseiling.jpg",
    ...
    {
      src: "/Must visting/white-water-rafting-at-kitulgala.jpg",
    ...
    {
      src: "/Must visting/Makandawa Rainforest Reserve02-E.JPG",
  ...
  return (
    <div className="bg-gray-100 min-h-screen">
      ...
      <motion.div 
        ...
        style={{ backgroundImage: "url('/images/Kithulgala.jpg')" }}
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
      ...
      <ScrollAnimation direction="up" delay={0.1}>
        <div className="container mx-auto px-6 py-12">
          <div className="bg-white shadow-lg rounded-lg p-6 flex flex-col md:flex-row gap-6 items-center">
            <img 
              src="/destinationbg/Kithulgala-map-m.jpg" 
              alt="Kithulgala" 
