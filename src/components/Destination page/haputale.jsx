...
export default function DestinationPlace() {
  const mustVisitPlaces = [
    {
      src: "/Must visting/Adisham Bungalow.jpg",
    ...
    {
      src: "/Must visting/Diyaluma Falls.jpg",
    ...
    {
      src: "/Must visting/Dambatenne Tea Factory.jpeg",
  ...
  return (
    <div className="bg-gray-100 min-h-screen">
      ...
      <motion.div 
        ...
        style={{ backgroundImage: "url('/images/haputhale.jpg')" }}
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
      ...
      <ScrollAnimation direction="up" delay={0.1}>
        <div className="container mx-auto px-6 py-12">
          <div className="bg-white shadow-lg rounded-lg p-6 flex flex-col md:flex-row gap-6 items-center">
            <img 
              src="/destinationbg/Haputale-map-m.jpg" 
              alt="Haputale" 
