...
export default function DestinationPlace() {
  const mustVisitPlaces = [
    ...
    {
      src: "/Must visting/Ravana_Falls.jpg",
      title: "Ravana Falls",
    ...
    {
      src: "/Must visting/Ella Rock.jpg",
      title: "Ella Rock",
      ...
      >
        <div className="absolute inset-0 bg-black bg-opacity-50 flex flex-col items-center justify-center text-center px-4">
          ...
          <p className="text-white text-xl font-serif mt-2">
            A Scenic Paradise in Sri Lanka
          </p>
        </div>
      </motion.div>
      ...
      <ScrollAnimation direction="up" delay={0.1}>
        <div className="container mx-auto px-6 py-12">
          <div className="bg-white shadow-lg rounded-lg p-6 flex flex-col md:flex-row gap-6 items-center">
            <img
              src="/destinationbg/Ella-Map-500.jpg"
              alt="Ella"
            ...
            <div>
              ...
              <br />
              <a
                href="https://maps.app.goo.gl/SBXhBwyuA1FyNMV88"
                target="_blank"
