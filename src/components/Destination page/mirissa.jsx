...
export default function DestinationPlace() {
  const mustVisitPlaces = [
    {
      src: "/Must visting/Mirissa-Beach.jpg",
      title: "Mirissa Beach ",
    ...
    {
      src: "/Must visting/LSL_B2_Parrot-Rock_1920x700.jpg",
      title: "Parrot Rock ",
    ...
    {
      src: "/Must visting/Whale Watching Tours.jpg",
  ...
  return (
    <div className="bg-gray-100 min-h-screen">
      ...
      <motion.div 
        ...
        style={{ backgroundImage: "url('/images/mirissa.jpg')" }}
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
      ...
      <ScrollAnimation direction="up" delay={0.1}>
        <div className="container mx-auto px-6 py-12">
          <div className="bg-white shadow-lg rounded-lg p-6 flex flex-col md:flex-row gap-6 items-center">
            <img 
              src="/destinationbg/mirissa-Map-m.jpg" 
              alt="Mirissa" 
